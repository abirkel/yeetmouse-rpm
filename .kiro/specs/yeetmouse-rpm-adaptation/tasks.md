...
- [x] 3. Copy and adapt check-release.yml workflow





  - [x] 3.1 Copy workflow file from maccel-rpm
  ...
  - [x] 3.2 Update repository references
  ...
  - [x] 3.3 Modify release detection to use commits instead of tags
  ...
  - [x] 3.4 Update .external_versions when commit changes
  ...
  - [x] 3.5 Update .external_versions variable names
  ...
  - [x] 3.6 Update build trigger parameters
...
- [x] 4. Copy and adapt build-rpm.yml workflow




  - [x] 4.1 Copy workflow file from maccel-rpm
  ...
  - [x] 4.2 Update workflow input names
  ...
  - [x] 4.3 Update load-config job (keep as-is)

    - No changes needed - already reads build.conf correctly
    - _Requirements: 4.3, 4.4, 4.5_
  
  - [x] 4.4 Modify update-specs job for commit-based versioning


    - [x] 4.4.1 Update "Determine maccel version" step
    ...
    - [x] 4.4.2 Add DKMS_VER extraction step
    ...
    - [x] 4.4.3 Update spec file update logic
    ...
    - [x] 4.4.4 Update commit message


      - Change from "update spec files to version X" to "update spec files to version X (commit Y)"
      - _Requirements: 7.7_
  
  - [x] 4.5 Update build-rpm job package names

    - [x] 4.5.1 Update "Get version from spec" step
    ...
    - [x] 4.5.2 Update "Download maccel source" step name
    ...
    - [x] 4.5.3 Update package build step names
    ...
    - [x] 4.5.4 Update package exclusion patterns
    ...
    - [x] 4.5.5 Update package copy patterns
  ...
  - [x] 4.6 Update publish job for YeetMouse

    - [x] 4.6.1 Update release notes template
    ...
    - [x] 4.6.2 Update release tag format
